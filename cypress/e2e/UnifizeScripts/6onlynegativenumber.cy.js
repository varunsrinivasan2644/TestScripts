describe('testscripts on unifize app', () => {
    ...
    it.only('Testing the number with only negative number including float', () => {
        ...
        cy.get('header > .chakra-input').type('Testing the number with negative number within -100')
        ...
        cy.get('.css-1e4rb2a').contains('Testing the number with negative number within -100').click()
    ...
    cy.wait(3000)
        ...
        cy.get('.css-1is2g17').click()
        cy.get('.css-yncqvq').type('-0.5')
        cy.get('.css-1q5hvdi').click()
        cy.get('.css-10zelb5').dblclick()

        cy.get('.css-1is2g17').click()
       cy.get('.css-yncqvq').type('-20.6756')
       cy.get('.css-1q5hvdi').click()
