describe('testscripts on unifize app', () => {
    ...
    it.only('Testing the number with min 20 and max 100 with only floating point upto 3', () => {
        ...
        cy.get('header > .chakra-input').type('Testing the number with floating values')
        cy.get('#description').type('Testing the number with floating point upto 3')
        ...
        cy.get('.css-1e4rb2a').contains('Testing the number with floating values').click()
        cy.get(8000)
        cy.get('.css-aggl2l > :nth-child(3)').click()
        cy.get('#title').type('Testing the number field with floating points')
    ...
    //     //ADDING NUMBER IN NUMBERFIELD
          cy.get('.css-mze1nh > :nth-child(1) > .chakra-input').type('Enter Number between only 20-100 with floating point 3')
    ...
    cy.wait(3000)
        ...
        cy.get('.css-1is2g17').click()
       cy.get('.css-yncqvq').type('70.678945')
       cy.wait(2000)
       cy.get('.css-1q5hvdi').click()
      })
    })
